...
public class Weapon_AutomaticGun : Weapon
{
    ...
    private float noAimSpreadFactor = 0.02f;                 
    ...
    private void Start()
    {
        ...
        soundClips.turnGunSound = Resources.Load<AudioClip>("Player/Sounds/Gun/TurnGun/TurnGunSound");
    ...
    public override void AimIn()
    {
        ...
        Debug.Log("fieldOfView" + mainCamera.fieldOfView);
        //瞄准声音
